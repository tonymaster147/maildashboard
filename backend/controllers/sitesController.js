...
exports.createSite = async (req, res) => {
  try {
    const {
      name, url, nickname, logo_url, favicon_url, site_key,
    ...
    const [result] = await db.query(
      `INSERT INTO sites
       (site_key, name, url, nickname, logo_url, favicon_url, from_name, from_email, contact_email,
       ...
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
      [
        key, name, url, nickname || null, logo_url || null, favicon_url || null,
...
exports.updateSite = async (req, res) => {
  try {
    ...
    const updates = [];
    const params = [];
    const assignable = ['name', 'url', 'nickname', 'logo_url', 'favicon_url', 'from_name', 'from_email', 'contact_email',
  ...
  try {
    ...
    res.json({
      site: {
        ...
        favicon_url: req.site.favicon_url || null,
        url: req.site.url,
